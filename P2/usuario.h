...
public:
  ...
  // Necesario declararlo al haber declarado el constructor de conversión
  // Con lo cual, el compilador no aportará el constructor por defecto
  //Clave();
...
public:
  ...
  Usuario(Cadena id, Cadena nombre, Cadena apellidos, Cadena direccion, Clave contrasena) throw(Id_duplicado);
